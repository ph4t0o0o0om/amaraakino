...
function CanvasDesigner() {
    ...
    designer.icons = {
    line: '/plugins/icons/line.png',
    arrow: '/plugins/icons/arrow.png',
    pencil: '/plugins/icons/pencil.png',
    dragSingle: '/plugins/icons/dragSingle.png',
    dragMultiple: '/plugins/icons/dragMultiple.png',
    eraser: '/plugins/icons/eraser.png',
    rectangle: '/plugins/icons/rectangle.png',
    arc: '/plugins/icons/arc.png',
    bezier: '/plugins/icons/bezier.png',
    quadratic: '/plugins/icons/quadratic.png',
    text: '/plugins/icons/text.png',
    image: '/plugins/icons/image.png',
    pdf: '/plugins/icons/pdf.png',
    marker: '/plugins/icons/marker.png',
    zoom_in: '/plugins/icons/zoom_in.png',
    zoom_out: '/plugins/icons/zoom_out.png',
    lineWidth: '/plugins/icons/lineWidth.png',
    colorsPicker: '/plugins/icons/colorsPicker.png',
    extraOptions: '/plugins/icons/extraOptions.png',
    undo: '/plugins/icons/undo.png',
    code: '/plugins/icons/code.png'
